...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 sm:py-28 bg-gradient-to-b from-background to-secondary/20">
            ...
            <Card className="bg-gradient-gold border-0 shadow-gold">
              <CardContent className="p-6 text-center">
                ...
                <Button
                  ...
                  onClick={() => window.open('https://wa.me/256709948920', '_blank')}
                >
                  Chat on WhatsApp
                </Button>
              </CardContent>
          ...
          <Card className="lg:col-span-2 border-border/50 shadow-elegant animate-fade-in">
            <CardContent className="p-8 sm:p-10">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-gold hover:opacity-90 text-primary font-semibold shadow-gold text-lg py-6 group"
                >
                  Send Message
